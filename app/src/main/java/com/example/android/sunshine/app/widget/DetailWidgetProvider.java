 ...
 */
@TargetApi(Build.VERSION_CODES.HONEYCOMB) public class DetailWidgetProvider
   ...
   */
  @TargetApi(Build.VERSION_CODES.ICE_CREAM_SANDWICH) private void setRemoteAdapter(Context context,
   ...
   * @param views RemoteViews to set the RemoteAdapter
   */
  @SuppressWarnings("deprecation") private void setRemoteAdapterV11(Context context,
      @NonNull final RemoteViews views) {
