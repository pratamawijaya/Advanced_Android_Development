...
public class Utility {
  ...
  public static boolean isLocationLatLonAvailable(Context context) {
    ...
    return prefs.contains(context.getString(R.string.pref_location_latitude)) && prefs.contains(
  ...
  public static String getFullFriendlyDayString(Context context, long dateInMillis) {
    ...
    int formatId = R.string.format_full_friendly_date;
    return String.format(
        context.getString(formatId, day, getFormattedMonthDay(context, dateInMillis)));
  }
   ...
   */
  @SuppressWarnings("ResourceType") static public @SunshineSyncAdapter.LocationStatus
